...
class TestGroupA:
    ...
    def test_A2_output_ports_of_fifo(self, gbundle):
        ...
        _t, _c, g = gbundle
        from scripts.semantic import find_by_name, neighbors, width_of  # noqa: F401
        ...
        from scripts.semantic import graph_query  # noqa: F401
        outputs: set[str] = set()
...
class TestGroupB:
    ...
    def test_B2_who_drives_fifo_full_reads_count(self, gbundle):
        ...
        _t, _c, g = gbundle
        from scripts.semantic import find_drivers, neighbors
    ...
    def test_B3_reads_of_fifo_din(self, gbundle):
        ...
        _t, _c, g = gbundle
        from scripts.semantic import reads_of
...
class TestGroupC:
    def test_C1_always_ff_sensitivity(self, gbundle):
        ...
        _t, _c, g = gbundle
        from scripts.semantic import sensitivity_of
...
class TestGroupD:
    def test_D1_backward_cone_of_fifo_full(self, gbundle):
        ...
        _t, _c, g = gbundle
        from scripts.semantic import cone_of_influence
        by_id = {n["id"]: n for n in g["nodes"]}
...
class TestGroupE:
    ...
    def test_E2_depth_is_read_by_widths_via_clog2(self, gbundle):
        ...
        _t, _c, g = gbundle
        from scripts.semantic import neighbors, find_by_name
...
class TestGroupF:
    ...
    def test_F2_empty_assign_compares_against_literal_zero(self, gbundle):
        ...
        _t, _c, g = gbundle
        from scripts.semantic import find_drivers
        from scripts.semantic import _text_of_subtree as text
