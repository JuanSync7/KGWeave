...
from kgweave.knowledge_graph.query.context_formatter import (
...
from kgweave.knowledge_graph.query.schemas import ExpansionResult
...
def collect_community_ids(
    ...
    """
    from kgweave.knowledge_graph.common.schemas import Entity  # local import to avoid circularity
