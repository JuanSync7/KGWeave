...
# Deps: logging, typing, spacy (optional), src.knowledge_graph.common.protocols (lazy)
# @end-summary
"""Two-tier entity matcher for query-time entity extraction.
...
class EntityMatcher:
    ...
    def _llm_match(self, query: str) -> List[str]:
        ...
        """
        from kgweave.knowledge_graph.common.protocols import get_default_llm  # noqa: PLC0415
