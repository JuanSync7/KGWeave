...
def _run_guard() -> None:
    ...
    spec = importlib.util.find_spec("kgweave.knowledge_graph")
    if spec is None:
    ...
    try:
        ...
        _il.import_module("kgweave.knowledge_graph.backend")
        _il.import_module("kgweave.knowledge_graph.common")
