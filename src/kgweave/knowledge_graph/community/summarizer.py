...
#        src.knowledge_graph.backend, src.knowledge_graph.common.protocols
# @end-summary
...
from kgweave.knowledge_graph.community.schemas import CommunityDiff, CommunitySummary
...
class CommunitySummarizer:
    ...
    def __init__(
        ...
        if llm_provider is not None:
            ...
            self._provider = get_default_llm()
