...
from kgweave.knowledge_graph.community.schemas import CommunitySummary, CommunityDiff

__all__ = ["CommunitySummary", "CommunityDiff"]

# --- Auto-generated re-exports (fix_encapsulation.py) ---
from kgweave.knowledge_graph.community.detector import CommunityDetector
from kgweave.knowledge_graph.community.summarizer import CommunitySummarizer
